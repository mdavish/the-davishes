...
export const navItems: NavItem[] = [
  {
    ...
    subtitle:
      <div className="flex flex-col font-serif text-center gap-y-4 lg:text-xl">
        <p>
        ...
        <p>
          We had our first date (expensed to EY) at the Kimpton Hotel Bar in Charlotte in October 2018 and enjoyed a few Boulevardiers and from that point forward, we spent basically every day together since.
        </p>
        <p>
  ...
  },
  {
    ...
    },
    {
      alt: "Wedding",
      src: "/villa.jpeg",
      caption: "Ashley and Max will tie the knot at Grand Real Villa Italia on July 8th 2023.",
    }],
    subtitle:
      <div className="">
        <p className="text-center font-serif">
          Get ready for a jam-packed weekend!
          You&apos;re coming all to Portugal to celebrate with us so we want to make sure that your weekend is full of fun, food, and booze.
